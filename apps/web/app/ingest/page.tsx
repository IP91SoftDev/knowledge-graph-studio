/**
 * Ingest Page - Placeholder
 * 
 * TODO: Implement resource ingestion pipeline
 */
...
export default async function IngestPage() {
  ...
  return (
    <AppShell
      ...
      breadcrumbs={[{ label: 'Home', href: '/' }, { label: 'Ingest' }]}
    >
        ...
        <div className="w-full max-w-md space-y-6 px-4 text-center">
          <div className="space-y-2">
            ...
            <p className="text-lg text-muted-foreground">
              Resource ingestion is under development
            </p>
          </div>
            ...
            <CardContent className="pt-0">
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li className="flex items-start gap-2">
                  ...
                  <span>Upload CSV/JSON exports</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1 text-primary">•</span>
                  <span>URL batch import</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1 text-primary">•</span>
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1 text-primary">•</span>
                  <span>Deduplication and validation</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1 text-primary">•</span>
                  <span>Progress tracking and logs</span>
                </li>
              </ul>
            </CardContent>
          </Card>
